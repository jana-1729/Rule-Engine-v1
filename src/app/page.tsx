          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24 lg:pt-32 lg:pb-32">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
                Stop building integrations from scratch. Our embedded platform
                handles OAuth, tokens, and API complexities - so you can focus
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
                <Link href="/signup">
                  <Button
                    size="lg"
                    className="w-full sm:w-auto text-base px-8 py-6 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 shadow-lg hover:shadow-xl transition-all"
                  >
                    Start Free Trial
                    <svg
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Built for developers, designed for scale. Ship integrations 10x
                faster.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="group p-8 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl border border-blue-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Connect with Slack, Notion, and more. New integrations added
              ...
              <div className="group p-8 bg-gradient-to-br from-orange-50 to-amber-50 rounded-2xl border border-orange-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Track every execution with detailed logs, error tracking, and
                  performance metrics.
                </p>
              </div>
              ...
              <div className="group p-8 bg-gradient-to-br from-cyan-50 to-blue-50 rounded-2xl border border-cyan-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Never worry about expired tokens. We handle refresh
              ...
              <div className="group p-8 bg-gradient-to-br from-indigo-50 to-purple-50 rounded-2xl border border-indigo-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Create complex workflows with our drag-and-drop builder. No
                  code required.
                </p>
              </div>
            </div>
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Pre-built integrations with popular SaaS platforms. More added
                every week.
              </p>
            </div>
        ...
        <section className="py-24 bg-gradient-to-br from-blue-600 to-purple-600">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-blue-100 mb-10 max-w-2xl mx-auto">
              Join hundreds of companies using our platform to power their
              integrations.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/signup">
                <Button
                  size="lg"
                  className="w-full sm:w-auto bg-white text-blue-600 hover:bg-gray-50 px-8 py-6"
                >
                  Start Free Trial
                </Button>
              </Link>
              <Link href="/docs">
                <Button
                  size="lg"
                  variant="outline"
                  className="w-full sm:w-auto border-2 border-white text-white bg-white/10 px-8 py-6"
                >
                  View Documentation
                </Button>
              </Link>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
              <div className="col-span-1 md:col-span-2">
                ...
                <p className="text-sm mb-4 max-w-md">
                  The embedded Rule Engine for SaaS companies. Add 100+
                  integrations in minutes, not months.
                </p>
              </div>
